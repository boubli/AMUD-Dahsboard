...
- **النقر على كامل البطاقة** — افتح التطبيق بالنقر في أي مكان على البطاقة؛ الأزرار والعناصر داخل البطاقة كما هي
- **إحصاءات التكامل ظاهرة دائمًا** — AdGuard و*arr وqBittorrent وغيرها تظهر على البطاقة بدون تمرير المؤشر
- **ربط القرص والشبكة** — قوائم الواجهات ونقاط التركيب تُنظَّف وتُزال التكرارات عند الحفظ؛ نص المساعدة في الإعدادات محدَّث
