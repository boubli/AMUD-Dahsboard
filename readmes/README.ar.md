...
- **خمول ذكي** — تتوقف الاستطلاعات والذاكرة المؤقتة عندما لا يستخدم أحد لوحة التحكم؛ سرعة كاملة عند فتح الواجهة (فترة سماح قابلة للتكوين)
- **ملفات الأداء** — Light أو Balanced أو Active أو Custom في الإعدادات → الأداء والموارد
- **homelab متعدد العقد** — وسم التطبيقات والوكلاء حسب العقدة؛ قياس عن بُعد وحاويات لكل مضيف
- **تكاملات دفعية** — حتى 50 بطاقة في طلب API واحد
- **نطاقات رموز API** — اختر القياس عن بُعد وwebhooks والتكاملات عند إنشاء الرمز
- **تذكيرات النسخ الاحتياطي** — تنبيه عند تأخر التصدير؛ تصدير متدفق لقواعد البيانات الكبيرة
- **تنبيهات المضيف في الخمول** — عتبات CPU وRAM والقرص عبر webhook عند إغلاق الواجهة
- **v1.7.7** — فواصل استطلاع قابلة للتكوين، مفتاح Feeds، الوضع الفاتح لكل سمة

السجل الكامل: **[سجل التغييرات](https://boubli.github.io/AMUD-Dashboard/docs/changelog)**

### حالة الإصدار

الإصدار الموصى به: **v1.8.0**. التفاصيل والإصدارات المسحوبة: **[README الإنجليزي](../README.md)** (قسم Release status).
