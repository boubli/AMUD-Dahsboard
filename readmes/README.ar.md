...
### ما الجديد في v1.5.5.9

- **شبكة bento موحّدة** — أحجام مختلطة (1x1، 2x1، 1x2) بدون فراغات عمودية بين الصفوف
- **معاينة الإعدادات** — معاينة المظهر الحية تعكس تخطيط صفوف bento
- **إصلاحات حديثة (v1.5.5.7–8)** — قالب Unraid بشبكة المضيف، بلاطات قرص لكل mount، **اختبار رؤية المضيف**، وإصلاح HTTP 415 في الإعدادات

السجل الكامل: **[سجل التغييرات](https://boubli.github.io/AMUD-Dashboard/docs/changelog)**

### حالة الإصدارات (تدقيق 2026-06-25)
...
- `v1.5.5.3`
- `v1.5.5.6`
- `v1.5.5.9` (الأحدث الموصى به حاليًا)
