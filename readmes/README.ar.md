...
### حالة الإصدار (تدقيق 2026-06-25)

بعد التحقق اليدوي في حاوية اختبار Proxmox نظيفة، يتم حاليًا الاحتفاظ بهذه الإصدارات كخطوط أساسية معروفة وصالحة:
...
- `v1.5.6.3`
- `v1.5.6.4`
- `v1.6.0` (الإصدار الأحدث الموصى به حاليًا)
