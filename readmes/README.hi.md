...
- **स्मार्ट आइडल** — जब कोई डैशबोर्ड नहीं देख रहा हो तो पोलर और कैश रुकते हैं; GUI खोलते ही पूरी गति (कॉन्फ़िगर करने योग्य ग्रेस अवधि)
- **प्रदर्शन प्रीसेट** — सेटिंग्स → प्रदर्शन और संसाधन में Light, Balanced, Active या Custom
- **मल्टी-नोड homelab** — ऐप और एजेंट को नोड टैग; प्रति होस्ट टेलीमेट्री और कंटेनर मिलान
- **बैच इंटीग्रेशन** — एक API अनुरोध में अधिकतम 50 कार्ड
- **API टोकन स्कोप** — टोकन बनाते समय टेलीमेट्री, webhook, इंटीग्रेशन आदि चुनें
- **बैकअप रिमाइंडर** — निर्यात अतिदेय होने पर सूचना; बड़े DB के लिए स्ट्रीमिंग निर्यात
- **आइडल होस्ट अलर्ट** — GUI बंद होने पर CPU, RAM और डिस्क webhook सीमाएँ
- **v1.7.7** — कॉन्फ़िगर करने योग्य पोल अंतराल, Feeds टॉगल, प्रति-थीम लाइट मोड

पूरा इतिहास: **[चेंजलॉग](https://boubli.github.io/AMUD-Dashboard/docs/changelog)**

### रिलीज़ स्थिति

अनुशंसित: **v1.8.0**. विवरण: **[अंग्रेज़ी README](../README.md)** (Release status अनुभाग)।
