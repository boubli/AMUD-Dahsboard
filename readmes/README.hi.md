...
- **प्रदर्शन** — कॉन्फ़िगर करने योग्य पोल अंतराल; एजेंट selective sysinfo और Docker/LXC कैश
- **Feeds** — पृष्ठभूमि RSS पोलिंग बंद करें और Feeds पेज छुपाएँ (स्रोत DB में रहते हैं)
- **लाइट मोड** — प्रति-थीम पैलेट; सेटिंग्स प्रीव्यू थीम CSS वेरिएबल पढ़ता है
- **v1.7.6** — मेमोरी अनुकूलन (PVE/Docker pooling, mimalloc, Tokio)

पूरा इतिहास: **[चेंजलॉग](https://boubli.github.io/AMUD-Dashboard/docs/changelog)**

### रिलीज़ स्थिति

अनुशंसित: **v1.7.7**. विवरण: **[अंग्रेज़ी README](../README.md)** (Release status अनुभाग)।
