...
### v1.5.5.9 में नया क्या है

- **एकसमान bento ग्रिड** — मिश्रित आकार (1x1, 2x1, 1x2) पंक्तियों के बीच अजीब ऊर्ध्वाधर खाली जगह के बिना
- **सेटिंग्स पूर्वावलोकन** — उपस्थिति लाइव पूर्वावलोकन bento पंक्ति लेआउट दिखाता है
- **हाल के सुधार (v1.5.5.7–8)** — Unraid होस्ट नेटवर्क टेम्पलेट, प्रति माउंट डिस्क टाइल, **होस्ट दृश्यता परीक्षण**, सेटिंग्स HTTP 415 फिक्स

पूरा इतिहास: **[बदलावों की सूची](https://boubli.github.io/AMUD-Dashboard/docs/changelog)**

### रिलीज़ स्थिति (2026-06-25 ऑडिट)
...
- `v1.5.5.3`
- `v1.5.5.6`
- `v1.5.5.9` (वर्तमान में अनुशंसित नवीनतम)
