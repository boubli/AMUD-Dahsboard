...
- **Jellyfin पोस्टर** — स्ट्रीम कार्ड पर फ़िल्म/एपिसोड की असली आर्टवर्क, सर्वर प्रॉक्सी के ज़रिए (API कुंजी कभी ब्राउज़र तक नहीं पहुँचती)
- **प्लेबैक नियंत्रण** — सक्रिय Jellyfin सत्र को रोकें / फिर से चलाएँ / बंद करें (केवल एडमिन); सिर्फ़ प्लेबैक के दौरान दिखते हैं
- **मीडिया इंटीग्रेशन अब «ऐप जोड़ें» में** — Jellyfin/Emby और Plex ऐप कार्ड पर कॉन्फ़िगर होते हैं; पुरानी सेटिंग्स की साख अपने आप माइग्रेट होती है
- **रीलोड पर तुरंत स्थिति** — `CHECKING...` की जगह स्थिति और कंटेनर CPU/RAM तुरंत दिखते हैं
- **Taghawsa थीम** — माउस रिपल के साथ WebGL एनिमेटेड ग्रेडिएंट (कुल 38 थीम)
- **कंटेनर एक्शन फ़िक्स** — स्वचालित पुनःप्रयास और स्पष्ट त्रुटियों से `client error (SendRequest)` हल
- **v1.8.0** — स्मार्ट आइडल, प्रदर्शन प्रीसेट, मल्टी-नोड, बैच इंटीग्रेशन, API टोकन स्कोप

पूरा इतिहास: **[चेंजलॉग](https://boubli.github.io/AMUD-Dashboard/docs/changelog)**

### रिलीज़ स्थिति

अनुशंसित: **v1.8.1**. विवरण: **[अंग्रेज़ी README](../README.md)** (Release status अनुभाग)।
