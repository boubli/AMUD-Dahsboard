...
- **पूरी कार्ड पर क्लिक** — कार्ड के किसी भी हिस्से पर क्लिक से ऐप खुलता है; अंदर के बटन/कंट्रोल पहले जैसे काम करते हैं
- **इंटीग्रेशन आँकड़े हमेशा दिखें** — AdGuard, *arr, qBittorrent आदि बिना होवर के कार्ड पर
- **डिस्क और नेटवर्क मैपिंग** — इंटरफ़ेस और माउंट सूचियाँ सेव पर साफ़ और डुप्लिकेट-मुक्त; सेटिंग्स में मदद टेक्स्ट अपडेट
