...
После ручной проверки в чистом тестовом контейнере Proxmox следующие выпуски сохранены в качестве заведомо исправных базовых версий:
...
- `v1.5.6.3`
- `v1.5.6.4`
- `v1.6.0` (рекомендуется в настоящее время)

Поврежденные теги, выявленные в ходе аудита, были удалены из релизов/тегов GitHub и не должны использоваться. **Не используйте `v1.5.5.4` и `v1.5.6.1` (отозвана).**
