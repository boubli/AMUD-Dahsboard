...
### Что нового в v1.5.5.9

- **Равномерная bento-сетка** — смешанные размеры (1x1, 2x1, 1x2) без вертикальных пустот между рядами
- **Предпросмотр в настройках** — сетка «Внешний вид» отражает построчный bento-макет
- **Недавние исправления (v1.5.5.7–8)** — шаблон Unraid с host-сетью, плитки диска по mount, **Проверка видимости хоста** и исправление HTTP 415 в настройках

Полная история: **[Список изменений](https://boubli.github.io/AMUD-Dashboard/docs/changelog)**

### Статус релизов (аудит 2026-06-25)
...
- `v1.5.5.3`
- `v1.5.5.6`
- `v1.5.5.9` (текущая рекомендуемая)
