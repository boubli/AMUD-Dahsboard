...
1. Open the [Theme Gallery](https://boubli.github.io/AMUD-Dashboard/themes)
...
Images were sourced from [Unsplash](https://unsplash.com/license) and [Pexels](https://www.pexels.com/license/) (free for commercial use, no attribution required). They are **vendored in this repository** so users are not dependent on third-party hotlinks.

See [CREDITS.md](./CREDITS.md) for source details.
