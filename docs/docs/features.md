...
Complete inventory of what AMUD Dashboard ships today (v1.8.12). Everything below is implemented in the compiled Rust binaries — no YAML files, no Node.js runtime.
